...
% 1. Ideia do projeto
% 2. alternativas
% 3. como funciona uma rede neural recorrente
% 4. diferentes modelos para uma rede neural recorrente (GRU,LSTM)
% 5. Nossa rede e seu modelo
% 6. O que é uma "Embedding layer"
% 6.5 Datasets
% 7. Nossos resultados, (com diferentes textos e diferentes modelos)
% 8. (Opcional) O que vem depois - atenção
% 9. Hardware utilizado


%%%%%%%%% TITLE
\title{Projeto Final -  Introdução a Aprendizado de Máquina ICP-365}

\author{Prof. João Carlos\\
{\tt\small jpcs@ic.ufrj.br}
\and
Eduardo Monteiro\\
{\tt\small eduardomc@dcc.ufrj.br}
\and
Erick Gaiote\\
{\tt\small erickgs@dcc.ufrj.br}
\and
Henrique Cardoso\\
{\tt\small henriquelc@dcc.ufrj.br}
}
...
\begin{figure}[t]
\begin{center}
   \includegraphics[width=20px]{figures/508px-Methuselah_Stained_glass.jpeg}
\end{center}
...
\begin{figure*}
\begin{center}
   \includegraphics[width=100px]{figures/508px-Methuselah_Stained_glass.jpeg}
\end{center}
   \caption{Example illustrating how to get BibTeX references from
